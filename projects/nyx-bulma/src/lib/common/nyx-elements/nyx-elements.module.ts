...
import { NyxMessageComponent } from './nyx-message/nyx-message.component';
...
const NYX_COMPONENTS = [
  ...
  NyxNotificationComponent, NyxProgressBarComponent, NyxTagComponent, NyxTitleComponent, NyxMessageComponent
];
